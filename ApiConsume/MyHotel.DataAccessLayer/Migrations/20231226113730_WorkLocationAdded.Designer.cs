...
namespace MyHotel.DataAccessLayer.Migrations
{
    ...
    [Migration("20231226113730_WorkLocationAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Guest", b =>
                {
                    ...
                    b.Property<string>("GuestIdentityNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("MyHotel.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MyHotel.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("MyHotel.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("MyHotel.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("MyHotel.EntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
